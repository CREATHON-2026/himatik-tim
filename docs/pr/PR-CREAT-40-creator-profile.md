...
## 📌 Ringkasan Perubahan
Pull Request ini mengimplementasikan fitur **Pengaturan Profil Sanggar & Etalase Kreator** pada dashboard mitra Gifteria. Fitur ini memungkinkan artisan/kreator kriya untuk memperbarui identitas sanggar (nama toko, deskripsi filosofi kado, logo studio), detail lokasi workshop untuk pengiriman, nomor kontak WhatsApp bisnis, serta melihat simulasi pratinjau etalase publik secara real-time.
...
- [`app/dashboard/creator/profile/page.tsx`](file:///d:/2-Project/Gifteria/app/dashboard/creator/profile/page.tsx):
...
- [`features/creator-profile/components/CreatorProfileForm.tsx`](file:///d:/2-Project/Gifteria/features/creator-profile/components/CreatorProfileForm.tsx):
...
- [`app/api/creator-profile/route.ts`](file:///d:/2-Project/Gifteria/app/api/creator-profile/route.ts):
  - Handler `GET` & `PUT` yang menghubungkan tabel `CreatorProfile` dan model `User`.
- [`app/api/upload/route.ts`](file:///d:/2-Project/Gifteria/app/api/upload/route.ts):
...
👉 [`docs/test/CREAT-40-creator-profile.md`](file:///d:/2-Project/Gifteria/docs/test/CREAT-40-creator-profile.md)
