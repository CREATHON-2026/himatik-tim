...
export interface LoaderSkeuoProps extends React.ComponentProps<"div"> {
  size?: number | string;
  variant?: "skeuo" | "skeuo-forest" | "skeuo-gold";
}
...
export function LoaderSkeuo({
  ...
  return (
    <div
      ...
      className={cn(
        "loader",
        variant === "skeuo" && "loader-skeuo-paper",
        variant === "skeuo-forest" && "loader-skeuo-forest",
        variant === "skeuo-gold" && "loader-skeuo-gold",
        className
      )}
      style={{
        ...style,
