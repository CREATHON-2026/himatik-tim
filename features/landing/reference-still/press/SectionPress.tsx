  ...
  (props, ref) => {
    return (
      <section
        ...
        id="press"
        {...props}
        className="relative w-full min-h-screen bg-[#111214] text-white px-6 md:px-14 flex flex-col justify-between overflow-hidden border-t border-white/10 shadow-[0_-30px_80px_rgba(0,0,0,0.75)] z-40"
      >
        {/* Top Header Area */}
        <div className="mx-auto w-full max-w-360 pt-[calc(56px+clamp(16px,3vh,36px))] pb-6">
          ...
          <h2 className="font-serif text-3xl font-light tracking-tight text-white sm:text-5xl md:text-6xl uppercase">
            Quietly Noticed.
          </h2>
        </div>
